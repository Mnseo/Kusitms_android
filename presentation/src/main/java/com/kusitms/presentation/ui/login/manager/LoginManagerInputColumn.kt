...
fun LoginManagerInputColumn(
    ...
    Column(modifier = Modifier
        ...
        androidx.compose.material3.Text(
            text= stringResource(id = R.string.login_manager_id_caption),
        ...
        //pw Input
        androidx.compose.material3.Text(
            text= stringResource(id = R.string.login_manager_pw_caption),
            style = KusitmsTypo.current.Caption1,
            color = KusitmsColorPalette.current.Grey400
        )
        Spacer(modifier = Modifier.height(4.dp))
        LoginMemberPwInput(text = R.string.login_manager_pw_placeholder, value = pw, onValueChange = onPwChange)
        Spacer(modifier = Modifier.height(24.dp))
